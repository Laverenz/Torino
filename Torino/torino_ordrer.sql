...
CREATE TABLE `ordrer` (
  ...
  `Leveringsadresse` varchar(255) DEFAULT NULL,
  `TotalPris` decimal(10,2) DEFAULT NULL,
  `OrdreDato` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`OrdreID`),
  KEY `KundeID` (`KundeID`),
  CONSTRAINT `ordrer_ibfk_1` FOREIGN KEY (`KundeID`) REFERENCES `kunder` (`KundeID`)
...
INSERT INTO `ordrer` VALUES (1,1,'Baker Street 221B',140.00,'2024-11-18 14:36:54'),(2,2,'Rosenvej 12',75.00,'2024-11-18 14:36:54');
